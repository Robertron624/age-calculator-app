        ...
        <form action="GET" @submit.prevent="calculate">
          <div class="inputs">
            <div class="input-container">
              <label :class="{ 'error-label': inputErrors.daysErrors || dateError }" for="day"
                >Day</label
              >
              <input
                ...
                id="day"
              />
              <span v-if="inputErrors.daysErrors" class="error-msg">{{
                inputErrors.daysErrors
              }}</span>
            </div>
            <div class="input-container">
              <label :class="{ 'error-label': inputErrors.monthsErrors || dateError }" for="month"
                >Month</label
              >
              <input
                :class="{ 'error-border': inputErrors.monthsErrors || dateError }"
                v-model="monthsInput"
                placeholder="MM"
                type="number"
                name="month"
                id="month"
              />
              <span v-if="inputErrors.monthsErrors" class="error-msg">{{
                inputErrors.monthsErrors
              }}</span>
            </div>
            <div class="input-container">
              <label :class="{ 'error-label': inputErrors.yearsErrors || dateError }" for="year"
                >year</label
              >
              <input
                :class="{ 'error-border': inputErrors.yearsErrors || dateError }"
                v-model="yearsInput"
                placeholder="YYYY"
                type="number"
                name="year"
                id="year"
              />
              <span v-if="inputErrors.yearsErrors" class="error-msg">{{
                inputErrors.yearsErrors
              }}</span>
            </div>
          </div>
